...
def protein_init(seqs):
    result_dict = {}
    local_model_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "esm2_t33_650M_UR50D.pt")
    model_location = local_model_path if os.path.exists(local_model_path) else "esm2_t33_650M_UR50D"
